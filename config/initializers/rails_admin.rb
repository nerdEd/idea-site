# RailsAdmin config file. Generated on May 31, 2013 21:30
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Idea Site', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Idea', 'User', 'Vote']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Idea', 'User', 'Vote']
  ...
  #     configure :voter, :polymorphic_association 
